 ...
 */
public class PoliticalResumeFragment extends Fragment {


    public PoliticalResumeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_political_resume, container, false);
